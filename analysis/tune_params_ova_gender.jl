...
function run_model(fold, k)
	...
	@time writecsv(string(data_directory, "/impute_ova_gender_cv_k$(k)_fold$(fold).csv"), impute(glrm))
	@time writecsv(string(data_directory, "/impute_ova_gender_X_cv_k$(k)_fold$(fold).csv"), X)
	@time writecsv(string(data_directory, "/impute_ova_gender_Y_cv_k$(k)_fold$(fold).csv"), Y)
