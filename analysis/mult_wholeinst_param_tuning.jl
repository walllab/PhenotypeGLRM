...
for ifold=1:nfolds
    ...
    # write to file
	writecsv(string(data_directory, "/impute_mult_simplex_offset_cv_train_error_wholeinst$(k).csv"), train_error)
	writecsv(string(data_directory, "/impute_mult_simplex_offset_cv_test_error_wholeinst$(k).csv"), test_error)    
end
